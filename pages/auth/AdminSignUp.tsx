    ...
    const handleSignUp = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.user) {
                    ...
                    .insert([
                        {
                            ...
                            name: fullName,
                            role: 'ADMIN',
                            avatar: `https://ui-avatars.com/api/?name=${encodeURIComponent(fullName)}&background=9333EA&color=fff`
                        }
                    ]);
                ...
                alert('Organization account created successfully! Please log in.');
        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 to-purple-100 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 border-t-4 border-purple-600">
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-2xl font-bold text-slate-800">Register Organization</h2>
                    <p className="text-slate-500">Start managing your events effectively.</p>
                </div>
                ...
                <form onSubmit={handleSignUp} className="space-y-4">
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Organization / Admin Name</label>
                        <input
                            type="text"
                            value={fullName}
                ...
                <div className="mt-6 text-center text-sm text-slate-500">
                    ...
                    <Link to="/login/admin" className="text-purple-600 font-semibold hover:underline">
                        Log in
                    </Link>
                </div>
